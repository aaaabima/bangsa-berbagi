 ...
 * Use the [PengolahanSampahFragment.newInstance] factory method to
...
class PengolahanSampahFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PengolahanSampahFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PengolahanSampahFragment().apply {
